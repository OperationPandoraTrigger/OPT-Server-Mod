...
[
    QGVAR(trainingDontDeleteSectorMarkers), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    [
        "Im Training die Sektorlinien nicht löschen", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
        "Nach Ablauf der Waffenruhe können die Sektorlinien für eine bessere Übersicht beibehalten werden." + endl // Mouse-Over description of the above
    ],
    ["OPT Sektorkontrolle", "4 - Diverses"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
    true, // Default value <BOOLEAN>
    1, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
...
[
    ...
    "CHECKBOX", // setting type
    [
        "Im Training die Grenzlinien nicht löschen", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
...
[
    QGVAR(trainingDontDeleteSectorColors), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    [
        "Im Training die Sektoreinfärbung nicht löschen", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
        "Nach Ablauf der Waffenruhe kann die Sektoreinfärbung für eine bessere Übersicht beibehalten werden." + endl // Mouse-Over description of the above
    ],
    ["OPT Sektorkontrolle", "4 - Diverses"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
    true, // Default value <BOOLEAN>
    1, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
...
[
    QGVAR(trainingDontDeleteSectorNumberMarkers), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    [
        "Im Training die Sektorennummern nicht löschen", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
        "Nach Ablauf der Waffenruhe kann die Sektor-Nummerierung für eine bessere Übersicht beibehalten werden." + endl // Mouse-Over description of the above
    ],
    ["OPT Sektorkontrolle", "4 - Diverses"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
    true, // Default value <BOOLEAN>
    1, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
...
[
    QGVAR(trainingAllowPositionLogging), // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
    "CHECKBOX", // setting type
    [
        "Im Trainingsmodus erlauben Position zu loggen", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
        "Damit kann man im Mausradmenü die eigene Spielerposition mit einer Anmerkung in das Server-Log speichern." + endl // Mouse-Over description of the above
    ],
    ["OPT Sektorkontrolle", "4 - Diverses"], // Pretty name of the category where the setting can be found. Can be stringtable entry.
    true, // Default value <BOOLEAN>
    1, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
