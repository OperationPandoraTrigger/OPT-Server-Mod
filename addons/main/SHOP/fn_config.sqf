...
//  ["Classname",                                   BuyPrice,   SellPrice,  SellPriceEnemy, NeedsCargo, GivesCargo, Draggable,  Carriable,  CanRepair,  CanBeam,    GrabOffset,     GrabDir,    HeightOffset,   Side,   HardCap],
    ...
    ["OPT_B_T_LSV_01_armed_F",                      COST(35000),                            5,          4,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [-1, -1, -1]], // Prowler armed
    ["OPT_O_T_LSV_02_armed_F",                      COST(35000),                            5,          4,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [-1, -1, -1]], // Prowler armed
    ["OPT_B_LSV_01_AT_F",                           COST(250000),                           5,          2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  2,  3]], // Prowler AT
    ["OPT_O_LSV_02_AT_F",                           COST(250000),                           5,          2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  2,  3]], // Prowler AT
    ...
    ["OPT_B_MRAP_01_hmg_F",                         COST(80000),                            5,          4,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 5,  4,  4]], // Hunter HMG
    ["OPT_O_MRAP_02_hmg_F",                         COST(80000),                            5,          4,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 5,  4,  4]], // Ifrit HMG
...
//  ["Classname",                                   BuyPrice,   SellPrice,  SellPriceEnemy, NeedsCargo, GivesCargo, Draggable,  Carriable,  CanRepair,  CanBeam,    GrabOffset,     GrabDir,    HeightOffset,   Side,   HardCap],
    ...
    ["OPT_O_Heli_Transport_04_box_F",               15000,      10000,      20000,          0,          4,          false,      false,      true,       false,      [0, 3, 0.2],    0,          0.1,            east,   [-1, -1, -1]], // Taru Reparatur
    ["OPT_O_Heli_Transport_04_ammo_F",              15000,      10000,      20000,          0,          4,          false,      false,      false,      false,      [0, 3, 0.2],    0,          0.1,            east,   [-1, -1, -1]], // Taru Munition
    ["OPT_O_Heli_Transport_04_fuel_F",              15000,      10000,      20000,          0,          4,          false,      false,      false,      false,      [0, 3, 0.2],    0,          0.1,            east,   [-1, -1, -1]], // Taru Fuel
...
[
//  ["Classname",                                   BuyPrice,   SellPrice,  SellPriceEnemy, NeedsCargo, GivesCargo, Draggable,  Carriable,  CanRepair,  CanBeam,    GrabOffset,     GrabDir,    HeightOffset,   Side,   HardCap],
    ["OPT_B_APC_tracked_03_cannon_F",               COST(150000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  2,  4]], // Mora
    ["OPT_O_APC_Wheeled_01_cannon_F",               COST(150000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  2,  4]], // Marshall
    ["OPT_B_APC_Wheeled_03_cannon_F",               COST(200000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  2,  4]], // Gorgon
    ["OPT_O_APC_Tracked_02_cannon_F",               COST(200000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  2,  4]], // BTR-K
    ["OPT_B_APC_Tracked_01_AA_F",                   COST(320000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  1,  2]], // Cheetah
    ["OPT_O_APC_Tracked_02_AA_F",                   COST(320000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  1,  2]], // Tigris
    ["OPT_B_AFV_Wheeled_01_cannon_F",               COST(300000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  1,  2]], // Rhino
    ["OPT_O_AFV_Wheeled_01_cannon_F",               COST(300000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  1,  2]], // Rhino
    ["OPT_B_MBT_03_cannon_F",                       COST(500000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  0,  2]], // Kuma
    ["OPT_O_MBT_02_cannon_F",                       COST(500000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  0,  2]], // T-100
    ["OPT_B_MBT_01_arty_F",                         COST(350000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  1,  1]], // Rohr Arty
    ["OPT_O_MBT_02_arty_F",                         COST(350000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  1,  1]], // Rohr Arty
    ["OPT_B_Truck_02_MRL_F",                        COST(400000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            west,   [ 0,  1,  1]], // Raketen Arty
    ["OPT_O_Truck_02_MRL_F",                        COST(400000),                           10,         2,          false,      false,      false,      true,       [0, 3, 0.2],    0,          0.1,            east,   [ 0,  1,  1]]  // Raketen Arty
];
