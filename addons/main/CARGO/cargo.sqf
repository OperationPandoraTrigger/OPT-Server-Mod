...
// NATO CUP
    ...
    ["CUP_B_SearchLight_static_USMC", 5],     // searchlight
    ["CUP_B_M252_USMC", 5],                   // m252 81mm
    ["CUP_B_TOW2_TriPod_USMC", 5],            // m220 tow 2
    ["CUP_B_M2StaticMG_MiniTripod_USMC", 5],  // M2 HD ministativ
    ["CUP_B_M2StaticMG_USMC", 5],             // M2 HD Hoch
...
// OPFOR CUP
    ...
    ["CUP_O_SearchLight_static_RU", 5],       // Searchlight
    ["CUP_O_2b14_82mm_RU", 5],                // Podnos2b14
    ["CUP_O_Kornet_RU", 5],                   // Kornet AT14
    ["CUP_O_KORD_RU", 5],                     // KORD ministativ
    ["CUP_O_DSHKM_SLA", 5],                   // DSHKM
