...
[
    ...
    "hoverin",
    {
        ...
        private _mapDisplay = ctrlParent _map;
        ...
        //DUMP(_dialog);
        //private _display = findDisplay IDD_GPS_GROUPHOVER;
...
*/
        ...
        _ctrlSquadDesc ctrlSetText (_group getVariable [QEGVAR(Squad,Description), ""]);
        _ctrlSquadCount ctrlSetStructuredText parseText format ["<t size=""%1"" align=""right"">%2 / %3</t>", _textSize, count _units, _groupSize];
        ...
        _ctrlMembers ctrlSetPosition [0, PY(4.4), PX(22), _unitCount * PY(1.8)];

        {
            _x ctrlCommit 0;
            nil;
        } count [_ctrlGrp, _ctrlSquadName, _ctrlSquadType, _ctrlSquadDesc, _ctrlSquadCount, _ctrlBgBottom, _ctrlMembers];
