...
player createDiaryRecord ["keys", ["Tastenbelegung","
	OPT Flagge ziehen - F3 (konfigurierbare Tastenbelegung unter OPT)<br/><br/>
"]];

player createDiaryRecord ["keys", ["Tastenbelegung","
	OPT Shop aufrufen in der Basis in Kaufbereich - F6 (konfigurierbare Tastenbelegung unter OPT)<br/><br/>
"]];

player createDiaryRecord ["keys", ["Tastenbelegung","
	OPT Konfig aufrufen in der Basis in Kaufbereich - F7 (konfigurierbare Tastenbelegung unter OPT)<br/><br/>
"]];

player createDiaryRecord ["keys", ["Feldreperatur", "
...
if (OPT_SECTORCONTROL_trainingon) then 
{
	...
	Im Trainingsmodus hat jeder Zugriff auf Zeus.
	"]];
